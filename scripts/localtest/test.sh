...
echo "instances, filename, res_runtime_without_prooflogging, res_time_genCardinals_without_PL, res_mem_without_prooflogging, res_runtime_with_prooflogging, res_time_genCardinals, res_time_genCardinalDefinitions,  res_mem_with_prooflogging, res_runtime_verification, res_mem_verification, res_verification_succeeded" > ./$(echo $file_results)
